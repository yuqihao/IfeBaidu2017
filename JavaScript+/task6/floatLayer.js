...
FloatLayer.prototype = {
    ...
    init: function() {
        ...
        this.maskEle.style.width = window.innerWidth + 'px';
        this.maskEle.style.height = window.innerHeight + 'px';
        this.maskEle.style.backgroundColor = 'rgba(108,108,108,0.3)';
...
(function() {
    ...
    var layer = createFloatLayer($('#floatLayer'));
     layer.show();
